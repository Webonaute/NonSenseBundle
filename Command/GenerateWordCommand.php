 ...
 */
class GenerateWordCommand extends ContainerAwareCommand
{
    /**
     * @see Command
     */
    ...
    {
        $this
            ->setName('nonsense:generate:word')
            ->setDescription('Generate a nonsense word sentence.')
            ->setHelp("");
    }
